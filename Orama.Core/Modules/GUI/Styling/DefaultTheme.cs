...
public class DefaultTheme : Theme
{
    ...
    public override Dictionary<Type, Style> NormalStyles { get; set; } = new()
    {
        ...
        { typeof(Button), new Style() { BackgroundColor = new(0.15f, 0.29f, 0.44f, 0.5f), TextColor = Color.White } },
    };

    public override Dictionary<Type, Style> HoverStyles { get; set; } = new()
    {
        { typeof(Button), new Style() { BackgroundColor = new(0.26f, 0.59f, 0.98f, 0.80f), TextColor = Color.White } },
    };
}
